...
**NOTE:** Modified version of [naming-cheatsheet](https://github.com/kettanaito/naming-cheatsheet).
...
**NOTES:** Use English language when naming your variables and functions.
...
**NOTES:**
- I personnaly use camel case for variables and functions.
- Pick **one** naming convention and follow it. It may be `camelCase`, or `snake_case`. What matters is for it to remain consistent.
